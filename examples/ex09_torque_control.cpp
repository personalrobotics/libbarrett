...
public:
  explicit J1Spring(double centerAngle, double springConstant = 10.0,
                    const std::string &sysName = "J1Spring")
      : systems::SingleIO<jp_type, jt_type>(sysName), center(centerAngle),
        gain(springConstant), jt(0.0) {}
...
int wam_main(int argc, char **argv, ProductManager &pm,
  ...
  printf("Press [Enter] to add a virtual spring to J1 (positive joint range "
         "only).");
  waitForEnter();
