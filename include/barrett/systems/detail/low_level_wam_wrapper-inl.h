  ...
  try {
    ...
    if (parent->llw.getSafetyModule() != NULL &&
      ...
      throw ExecutionManagerException(
          "systems::LowLevelWamWrapper::Source::operate(): E-stop! "
          "Cannot communicate with Pucks.");
    } else {
      throw;
    }
  }
