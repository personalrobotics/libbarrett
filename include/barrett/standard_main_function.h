 ...
 *
 * This "standard" main() function simply initializes the WAM in the normal way,
 * by:
 ...
 *
 * The wam_main() function must be able to accept a reference to both a 3-DOF,
 * 4-DOF and a 7-DOF barrett::systems::Wam. If your code treats these two cases
 * similarly, then define a templated function:
 * @include zero_torque.cpp
 *
 * If your code handles these two cases very differently, then define two
