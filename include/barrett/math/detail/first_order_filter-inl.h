...
FirstOrderFilter<T, MathTraits>::FirstOrderFilter(double timeStep)
    : a(MT::zero()), b(MT::zero()), c(MT::zero()), T_s(timeStep),
      c1(MT::zero()), c2(MT::zero()), c3(MT::zero()), y_0(MT::zero()),
      y_1(MT::zero()), x_0(MT::zero()), x_1(MT::zero()) {}

template <typename T, typename MathTraits>
FirstOrderFilter<T, MathTraits>::FirstOrderFilter(
    const libconfig::Setting &setting)
    : a(MT::zero()), b(MT::zero()), c(MT::zero()), T_s(0.0), c1(MT::zero()),
      c2(MT::zero()), c3(MT::zero()), y_0(MT::zero()), y_1(MT::zero()),
      x_0(MT::zero()), x_1(MT::zero()) {
...
template <typename T, typename MathTraits>
void FirstOrderFilter<T, MathTraits>::setFromConfig(
    const libconfig::Setting &setting) {
  // TODO(dc): test!
  T omega_p(MT::zero());
...
template <typename T, typename MathTraits>
void FirstOrderFilter<T, MathTraits>::setLowPass(const T &omega_p,
                                                 const T &dcGain) {
  a = MT::zero();
...
template <typename T, typename MathTraits>
void FirstOrderFilter<T, MathTraits>::setHighPass(const T &omega_p,
                                                  const T &hfGain) {
  a = hfGain;
  b = MT::zero();
  c = omega_p;
...
template <typename T, typename MathTraits>
void FirstOrderFilter<T, MathTraits>::setZPK(const T &omega_z, const T &omega_p,
                                             const T &dcGain) {
...
template <typename T, typename MathTraits>
void FirstOrderFilter<T, MathTraits>::setParameters(const T &a_, const T &b_,
                                                    const T &c_) {
  a = a_;
  b = b_;
  c = c_;
...
inline const T &FirstOrderFilter<T, MathTraits>::eval(const T &x_0) {
  ...
  y_0 =
      MT::sub(MT::add(MT::mult(c1, y_1), MT::mult(c2, x_0)), MT::mult(c3, x_1));
