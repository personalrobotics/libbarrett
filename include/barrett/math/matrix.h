...
class Matrix
    : public Eigen::Matrix<
          double, R, C, (C == 1 && R > 1) ? Eigen::ColMajor : Eigen::RowMajor> {
public:
  ...
  static const size_t SIZE =
      R * C; ///< Length of the array. Avoid using this if possible in case
             ///< dynamic sizing is supported in the future.
...
struct Traits<Eigen::MatrixBase<TraitsDerived>> {
  ...
  template <typename LDerived, typename RDerived>
  static const typename MatrixBaseType::PlainObject
