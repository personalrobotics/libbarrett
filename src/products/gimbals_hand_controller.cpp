...
GimbalsHandController::GimbalsHandController(Puck *_p6, Puck *_p7)
    : p6(*_p6), p7(*_p7), thumbOpen(false), thumbClose(false),
      pointerOpen(false), pointerClose(false), middleOpen(false),
      middleClose(false), rockerUp(false), rockerDown(false), knob(0),
      usingBrown(true), brown_1(0), dGreen_1(0)
